...
def test_1():
    ...
    assert output[5] == 'How many degrees Celsius?: '
...
def test_3():
    ...
    assert output[4] == 'Choose: 1.Kilometers -> Miles 2.Meters -> Yards 3.Meters -> Feet 4.Centimeters -> Inches ' \
                        '-------> '
    assert output[5] == 'All the best! :)'
...
def test_4():
    ...
    assert output[1] == 'Please, select by what criterion the conversion will be carried out - Temperature (1) or ' \
                        'Length (2) or Exit(Q) -------> '
    assert output[2] == 'Incorrect entry. Please try again.'
    assert output[3] == 'Choose: 1.Kilometers -> Miles 2.Meters -> Yards 3.Meters -> Feet 4.Centimeters -> Inches ' \
                        '-------> '
    assert output[4] == 'All the best! :)'
